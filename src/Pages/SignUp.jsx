...
const SignUp = () => {
  return (
        ...
        <h1 className='flex self-start md:pl-32 pl-20  font-montserrat lg:text-5xl md:text-4xl text-3xl font-bold'>Create Account</h1>
        <div className='flex flex-col gap-3 font-sans font-normal'>
          <p className=' md:text-xl text-lg'> Name</p>
          <div className='border border-border xl:w-[750px] lg:w-[550px] w-[350px] h-12 flex items-center justify-start sm:pl-3 pl-1 rounded-xl md:text-lg text-base'><input type="text" placeholder='Enter your name' /></div>
        ...
        <button className='xl:w-[750px] lg:w-[550px] w-[350px] h-12 bg-sign rounded-xl font-sans font-bold md:text-xl text-lg text-white'>Create Account</button>
